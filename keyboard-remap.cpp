...
// for differentiating between keyboards (not yet implemented)
const wchar_t* lenovo = L"ACPI\\VEN_LEN&DEV_0071";
const wchar_t* modelm = L"HID\\VID_FEED&PID_B155&REV_010&MI_00";
...
int main()
{
    ...
    while(interception_receive(context, device = interception_wait(context), &stroke, 1) > 0)
    {
        ...
        int isLenovo = wcscmp(lenovo, hardware_id);
        wcout << isLenovo << "  " << hardware_id << endl;
